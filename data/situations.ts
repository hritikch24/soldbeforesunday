import { an, titleCaseTerm, type Country } from './countries';
...
export const situations: Situation[] = [
  {
    ...
    title: (c) => `Sell Your House Fast to Stop ${titleCaseTerm(c.distressTerm)}`,
    ...
    body: (c) => [
      ...
      `A cash sale in ${c.days} can pay off the arrears and the mortgage before the lender takes the property, protecting your credit from the worst outcome and putting any remaining equity in your pocket instead of losing it.`,
  ...
  },
  {
    ...
    body: (c) => [
      `An inherited house often comes with baggage: probate paperwork, siblings to agree with, a property full of belongings, and sometimes decades of deferred maintenance. Listing it with ${an(c.agentTerm)} means paying for repairs and months of uncertainty first.`,
  ...
  },
  {
    ...
    body: (c) => [
      `In a separation, the house is usually the biggest shared asset and the biggest source of friction. A long, drawn-out sale with ${an(c.agentTerm)} — ${c.agentFee} — keeps both of you tied together for months.`,
  ...
  },
  {
    ...
    body: (c) => [
      `Rising costs, tightening regulations and difficult tenancies have many landlords ready for the exit. But selling a tenanted property through ${an(c.agentTerm)} is slow — and often impossible without vacant possession.`,
