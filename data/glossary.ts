...
export const glossary: Term[] = [
  ...
  { term: 'Mortgagee sale', where: 'Australia / NZ', def: 'A sale forced by the lender (mortgagee) after default. Selling before it reaches this stage usually nets the owner considerably more than the forced-sale outcome.' },
