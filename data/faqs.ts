...
export function faqsFor(c: Country): FAQ[] {
  return [
    ...
    { q: 'How do I know a cash buyer is legitimate and not a scam?', a: 'Three checks protect you completely: ask for proof of funds (a genuine buyer provides a bank statement or solicitor confirmation within a day), never pay anyone anything (legitimate buyers never charge sellers — any upfront \'fee\' is a scam), and have the contract reviewed by your own legal representative before signing. Buyers in our network are vetted, but you should run these checks on anyone, including them.' },
    ...
    { q: 'Can I sell before probate is complete?', a: 'You generally cannot complete a sale before probate (or its local equivalent) is granted, but you can absolutely get an offer agreed and paperwork prepared so the sale completes immediately after. Cash buyers are used to working around probate timelines.' },
    { q: 'What happens to my mortgage when I sell?', a: 'The mortgage is repaid from the sale proceeds at completion, including any arrears. If your mortgage is larger than the offer, talk to the buyer anyway — some situations have solutions (negotiated settlements, assisted sales) and an honest buyer will tell you quickly if yours does not.' },
