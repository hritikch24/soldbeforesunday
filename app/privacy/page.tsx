  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="mt-6 space-y-4 leading-relaxed opacity-80">
        ...
        <p><strong>Retention & your rights.</strong> We keep records only as long as needed to operate the service. You may request a copy of your data or its deletion at any time by contacting us through the contact page, and — where local law provides (GDPR in the UK/EU, CCPA in California, PIPEDA in Canada, the Privacy Act in Australia) — you have the corresponding statutory rights.</p>
